/* Site-wide jQuery, Angular, Bootstrap */
    ...
    /* ****************************************** */
    var btnShowDeveloperBugs =  function(){
        $('#my-developer-bugs').show();
    };
    var btnHideDeveloperBugs = function(){
        $('#my-developer-bugs').hide();
    };
    ...
    var exitApp = function() {
        ...
        $('body').html('Just close out... window.close() is not working on this browser, probably Firefox. <p>The sages foretold this fault would occur on: '+$('#myCornerClock2').html()+'</p>');
    };
